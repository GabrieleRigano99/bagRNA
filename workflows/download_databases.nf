...
process DOWNLOAD_DBCAN {
    ...
    wget -O CAZy.dmnd              "${base}/CAZy.dmnd"
    wget -O dbCAN.hmm              "${base}/dbCAN.hmm"
    wget -O dbCAN-sub.hmm          "${base}/dbCAN_sub.hmm"
    wget -O fam-substrate-mapping.tsv "${base}/fam-substrate-mapping.tsv"
    wget -O TCDB.dmnd              "${base}/TCDB.dmnd"
    wget -O TF.hmm                 "${base}/TF.hmm"
    wget -O TF.dmnd                "${base}/TF.dmnd"
    wget -O STP.hmm                "${base}/STP.hmm"
    wget -O PUL.dmnd               "${base}/PUL.dmnd"
    wget -O dbCAN-PUL.xlsx         "${base}/dbCAN-PUL.xlsx"
    wget -O dbCAN-PUL.tar.gz       "${base}/dbCAN-PUL.tar.gz"
